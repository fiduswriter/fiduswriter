...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_userprofile', (
            ...
            ('about', self.gf('django.db.models.fields.TextField')(max_length=500, blank=True)),
        ))
        db.send_create_signal('account', ['UserProfile'])

        # Adding model 'TeamMember'
        db.create_table('account_teammember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('leader', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leader', to=orm['auth.User'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member', to=orm['auth.User'])),
            ('roles', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('account', ['TeamMember'])

        # Adding unique constraint on 'TeamMember', fields ['leader', 'member']
        db.create_unique('account_teammember', ['leader_id', 'member_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'TeamMember', fields ['leader', 'member']
        db.delete_unique('account_teammember', ['leader_id', 'member_id'])

        # Deleting model 'UserProfile'
        db.delete_table('account_userprofile')

        # Deleting model 'TeamMember'
        db.delete_table('account_teammember')
    ...
    models = {
        ...
        'account.teammember': {
            'Meta': {'unique_together': "(('leader', 'member'),)", 'object_name': 'TeamMember'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'leader'", 'to': "orm['auth.User']"}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'member'", 'to': "orm['auth.User']"}),
            'roles': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        'account.userprofile': {
