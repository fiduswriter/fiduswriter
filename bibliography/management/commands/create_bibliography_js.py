...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        d = os.path.dirname(PROJECT_PATH+'/bibliography/static/js/es6_modules/bibliography/statics.js')
        if not os.path.exists(d):
            os.makedirs(d)

        bib_js_file = open(PROJECT_PATH+"/bibliography/static/js/es6_modules/bibliography/statics.js", "w")
