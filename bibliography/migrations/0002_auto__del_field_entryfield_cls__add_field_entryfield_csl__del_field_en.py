...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntryField.cls'
        db.delete_column(u'bibliography_entryfield', 'cls')

        # Adding field 'EntryField.csl'
        db.add_column(u'bibliography_entryfield', 'csl',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'EntryType.cls'
        db.delete_column(u'bibliography_entrytype', 'cls')

        # Adding field 'EntryType.csl'
        db.add_column(u'bibliography_entrytype', 'csl',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EntryField.cls'
        db.add_column(u'bibliography_entryfield', 'cls',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'EntryField.csl'
        db.delete_column(u'bibliography_entryfield', 'csl')

        # Adding field 'EntryType.cls'
        db.add_column(u'bibliography_entrytype', 'cls',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'EntryType.csl'
        db.delete_column(u'bibliography_entrytype', 'csl')
