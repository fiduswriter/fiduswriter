...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.cover_image'
        db.alter_column(u'book_book', 'cover_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usermedia.Image'], null=True))

    def backwards(self, orm):

        # Changing field 'Book.cover_image'
        db.alter_column(u'book_book', 'cover_image_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['usermedia.Image']))
    ...
    models = {
        ...
        u'text.text': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
