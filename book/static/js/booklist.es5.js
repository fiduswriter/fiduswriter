...
},{"./es6_modules/books/booklist":8}],2:[function(require,module,exports){
'use strict';
...
},{"../../exporter/zip":31}],4:[function(require,module,exports){
'use strict';
                    ...
                    switch (actionName) {
                        ...
                        case 'latex':
                            for (var _i = 0; _i < ids.length; _i++) {
                                ...
                                new _latex.LatexBookExporter(_aBook, that.user, that.documentList);
                            }
                            break;
                        case 'html':
                            for (var _i2 = 0; _i2 < ids.length; _i2++) {
                                ...
                                new HTMLBookExporter(_aBook2, that.user, that.documentList);
                            }
                            break;
                        case 'copy':
...
},{"../../exporter/epub-templates":22}],10:[function(require,module,exports){
"use strict";
    ...
    _createClass(EpubBookExporter, [{
        ...
        value: function exportOne() {
            ...
            for (var _i3 = 0; _i3 < chapters.length; _i3++) {
                ...
                chapters[_i3].contents = this.styleEpubFootnotes(chapters[_i3].contents);
    ...
    _createClass(HTMLBookExporter, [{
        ...
        value: function exportOne() {
            ...
            for (var _i = 0; _i < chapters.length; _i++) {
                ...
                _contents = this.cleanHTML(_contents);

                if (this.book.chapters[_i].part && this.book.chapters[_i].part != '') {
                    contentItems.push({
                        link: 'document-' + this.book.chapters[_i].number + '.html',
                        title: this.book.chapters[_i].part,
                        docNum: this.book.chapters[_i].number,
                        id: 0,
                        level: -1,
                        subItems: []
                    });
                ...
                // Make links to all H1-3 and create a TOC list of them
                contentItems = contentItems.concat(this.setLinks(_contents, this.book.chapters[_i].number));

                var contentsCode = this.replaceImgSrc(_contents.innerHTML);

                var htmlCode = (0, _htmlTemplates.htmlBookExportTemplate)({
                    part: this.book.chapters[_i].part,
                    title: title,
                ...
                outputList.push({
                    filename: 'document-' + this.book.chapters[_i].number + '.html',
                    contents: htmlCode
                });
            }
...
},{"../../bibliography/exporter/biblatex":3,"../../exporter/json":26,"../../exporter/latex":27,"../../exporter/tools":28,"../../exporter/zip":31,"./latex-templates":13,"./tools":15}],15:[function(require,module,exports){
"use strict";
...
},{"../bibliography/exporter/csl":4,"./citeproc-sys":17}],19:[function(require,module,exports){
'use strict';
...
},{"../bibliography/database":2,"../bibliography/exporter/biblatex":3,"./base":20,"./json":26,"./tools":28,"./zip":31}],28:[function(require,module,exports){
'use strict';
...
},{"./upload-templates":29}],31:[function(require,module,exports){
"use strict";
...
},{"./src/ParseError":42,"./src/Settings":44,"./src/buildTree":49,"./src/parseTree":58,"./src/utils":60}],39:[function(require,module,exports){
/** @flow */
...
},{"./ParseError":42,"match-at":39}],41:[function(require,module,exports){
/**
