...
declare -A PACKAGE_DIRS=(
    ...
    ["@fiduswriter/document-admin-editor"]="fiduswriter-document-admin-editor-ts"
...
SIBLING_PACKAGES=(
    ...
    "fiduswriter-document-admin-editor-ts:@fiduswriter/bibliography-manager,@fiduswriter/document,@fiduswriter/editor,@fiduswriter/image-manager,fwtoolkit"
