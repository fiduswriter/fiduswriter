...
project = u'fiduswriter'
copyright = u'2016, Johannes Wilm, Aleksandr Korovin'
...
latex_documents = [
  ('index', 'fiduswriter.tex', u'fiduswriter Documentation',
   u'Johannes Wilm, Aleksandr Korovin', 'manual'),
]
...
man_pages = [
    ('index', 'fiduswriter', u'fiduswriter Documentation',
     [u'Johannes Wilm, Aleksandr Korovin'], 1)
]
...
texinfo_documents = [
  ('index', 'fiduswriter', u'fiduswriter Documentation',
   u'Johannes Wilm, Aleksandr Korovin', 'fiduswriter', 'One line description of project.',
   'Miscellaneous'),
]
