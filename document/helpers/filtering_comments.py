...
def filter_comments_by_role(comments, access_rights, cur_phase, user_info):
    ...
    # 2) get from visibility dict instructions what to do. if always - add to
    # filtered comments
    for comment_id, comment in comments.iteritems():
        ...
        if user_info.user.id == user_id:
            ...
            # TODO: no info about owner in AccessRights table => exception.
            # remove this when resolve
        try:
        ...
        # if comment of reader role and current phase publication -
