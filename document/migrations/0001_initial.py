    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contents', models.TextField(default=b'{"nn":"DIV","a":[],"c":[{"nn":"P","c":[{"nn":"BR"}]}]}')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('note', models.CharField(default=b'', max_length=255, blank=True)),
                ('date', models.DateTimeField(auto_now=True)),
                ('file_object', models.FileField(upload_to=document.models.revision_filename)),
                ('file_name', models.CharField(default=b'', max_length=255, blank=True)),
