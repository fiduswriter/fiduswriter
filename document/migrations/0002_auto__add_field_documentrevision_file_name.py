...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentRevision.file_name'
        db.add_column(u'document_documentrevision', 'file_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentRevision.file_name'
        db.delete_column(u'document_documentrevision', 'file_name')
