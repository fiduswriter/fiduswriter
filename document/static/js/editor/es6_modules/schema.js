...
MetaDataSubtitle.prototype.serializeDOM = (node, serializer) =>
  serializer.renderAs(node, "div", {id: 'metadata-subtitle'})
...
MetaDataAuthors.prototype.serializeDOM = (node, serializer) =>
  serializer.renderAs(node, "div", {id: 'metadata-authors'})
...
MetaDataAbstract.prototype.serializeDOM = (node, serializer) =>
  serializer.renderAs(node, "div", {id: 'metadata-abstract'})
...
MetaDataKeywords.prototype.serializeDOM = (node, serializer) =>
  serializer.renderAs(node, "div", {id: 'metadata-keywords'})
...
Citation.register("command", "insert", {
  derive: {
    params: [
      {label: "Bibliography Format", attr: "bibFormat"},
      {label: "Bibliography Entry", attr: "bibEntry"},
      {label: "Text Before", attr: "bibBefore"},
      {label: "Page number", attr: "bibPage"}
    ]
  },
...
Figure.register("command", "insert", {
  derive: {
    params: [
      {label: "Equation", attr: "equation"},
      {label: "Image PK", attr: "image"},
      {label: "Category", attr: "figureCategory"},
      {label: "Caption", attr: "caption"}
    ]
  },
  label: "Insert figure",
  menu: {
...
CommentMark.register("parseDOM", "span", {parse: function(dom, state) {
