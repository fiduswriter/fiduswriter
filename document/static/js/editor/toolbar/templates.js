...
(function () {
  ...
  */
    ...
    toolbarTemplates.figureImage = _.template('\
        <div>\
    ...
    toolbarTemplates.configureFigure = _.template('\
    ...
    toolbarTemplates.configureCitation = _.template('\
    ...
    toolbarTemplates.selectedCitation = _.template('<tr id="selected-source-<%= id %>" class="selected-source"><td colspan="3" width="335">\
