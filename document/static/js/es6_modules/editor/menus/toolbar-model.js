...
export let toolbarModel = [
    ...
    },
    {
        type: 'dropdown',
        show: editor => {
            let startElement = editor.currentView.state.selection.$from.node(3),
                endElement = editor.currentView.state.selection.$to.node(3)
        ...
        disabled: editor => {
            let startElement = editor.view.state.selection.$from.node(3)
            return !startElement
        },
        content: [
            {
    ...
    },
    {
        ...
        disabled: editor => {
            if (editor.view !== editor.currentView) {
                return true
            } else if (
                editor.view.state.selection.$from.node(2) === editor.view.state.selection.$to.node(2) &&
                editor.view.state.selection.$from.node(3) &&
    ...
    },
    {
        ...
        disabled: editor => {
            if (editor.view !== editor.currentView || editor.view.state.selection.empty) {
                return true
            }
        }
    }
