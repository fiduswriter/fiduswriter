        ...
        props: {
           decorations: (state) => {
                ...
                if($head != undefined && $head.type.name == 'table'){
                    ...
                    let tableDropUp = document.createElement('span')
                     ...
                     tableDropUp.innerHTML = noSpaceTmp`
                        <div class="table-edit-button-group">
                                  <span class="ui-button-text" title="` + gettext("Insert row")+ `">
                                        <label class="row">` + gettext("Insert row ")+ `</label>
                                  </span>
                                  <span class="ui-button-text" title="` + gettext("Insert row before")+ `" style="display:none;">
                    ...
                    `
                    tableDropUp.querySelector('.table-edit-button-group').addEventListener('click', () => {
                    ...
                    let deco = Decoration.widget(startPos, tableDropUp)
