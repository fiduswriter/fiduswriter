...
export const docSchema = new Schema({
    nodes: {
        doc: {
            type: Doc,
            content: "article"
        }, // Transformations don't work well on the top most element
        article: {
            type: Article,
