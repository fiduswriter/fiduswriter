# Generated by Django 6.0 on 2026-05-16 22:43
import os
import zipfile
import tempfile
...
# FW 3.5 documents can be read as 3.6 but not vice versa.
OLD_FW_DOCUMENT_VERSION = 3.5
...
class Migration(migrations.Migration):
    dependencies = [
        ("document", "0025_make_holder_required"),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DecimalField(
                decimal_places=1, default=3.6, max_digits=3
            ),
        ),
        migrations.AlterField(
