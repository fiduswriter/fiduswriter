...
class ProfileTest(LiveTornadoTestCase, SeleniumHelper):
    ...
    def test_edit_profile(self):
        ...
        try:
            self.assertEqual(
                "Yeti",
                driver.find_element_by_id("last_name").get_attribute("value"),
            )
        ...
        try:
            self.assertEqual(
                "Snowman",
                driver.find_element_by_id("first_name").get_attribute("value"),
            )
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        try:
        ...
        # Test avatar upload
        self.assertEqual(
            len(driver.find_elements_by_css_selector("#profile-avatar img")), 0
        )
        ...
        self.assertEqual(
            len(driver.find_elements_by_css_selector("#profile-avatar img")), 1
        )
        driver.find_element_by_id("edit-avatar-btn").click()
        driver.find_element_by_xpath(
        ...
        self.driver.find_element_by_id("preferences-btn").click()
        ...
        driver.find_element_by_id("username-confirmation").send_keys("Yeti2")
        driver.find_element_by_id("password").send_keys("otter1")
