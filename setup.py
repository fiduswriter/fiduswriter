...
setuptools.setup(
    ...
    extras_require={
        "books": "fiduswriter-books ~= 3.10.13",
        "citation-api-import": "fiduswriter-citation-api-import ~= 3.10.3",
        "languagetool": "fiduswriter-languagetool ~= 3.10.6",
        "ojs": "fiduswriter-ojs ~= 3.10.5",
        "phplist": "fiduswriter-phplist ~= 3.10.2",
        "gitrepo-export": "fiduswriter-gitrepo-export ~= 3.10.8",
