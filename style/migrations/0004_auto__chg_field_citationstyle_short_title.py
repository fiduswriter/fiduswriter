...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CitationStyle.short_title'
        db.alter_column(u'style_citationstyle', 'short_title', self.gf('django.db.models.fields.SlugField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'CitationStyle.short_title'
        db.alter_column(u'style_citationstyle', 'short_title', self.gf('django.db.models.fields.SlugField')(max_length=20))
    ...
    models = {
        ...
        u'style.citationstyle': {
            ...
            'contents': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'short_title': ('django.db.models.fields.SlugField', [], {'max_length': '40'}),
