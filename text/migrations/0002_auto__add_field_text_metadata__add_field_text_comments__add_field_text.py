...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Text.metadata'
        db.add_column(u'text_text', 'metadata',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'Text.comments'
        db.add_column(u'text_text', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)

        # Adding field 'Text.settings'
        db.add_column(u'text_text', 'settings',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Text.metadata'
        db.delete_column(u'text_text', 'metadata')

        # Deleting field 'Text.comments'
        db.delete_column(u'text_text', 'comments')

        # Deleting field 'Text.settings'
        db.delete_column(u'text_text', 'settings')
    ...
    models = {
        ...
        u'text.text': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
