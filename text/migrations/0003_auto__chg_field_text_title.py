...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Text.title'
        db.alter_column(u'text_text', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        u'text.text': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
