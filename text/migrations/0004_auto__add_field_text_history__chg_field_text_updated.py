...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Text.history'
        db.add_column(u'text_text', 'history',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)


        # Changing field 'Text.updated'
        db.alter_column(u'text_text', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'Text.history'
        db.delete_column(u'text_text', 'history')


        # Changing field 'Text.updated'
        db.alter_column(u'text_text', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'text.text': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
