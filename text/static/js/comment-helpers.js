...
(function () {
    ...
    commentHelpers.createNewAnswer = function (parentId, commentText) {
        ...
        comment.setAttribute('data-comment-answer-'+an+'-comment', commentText);
        comment.setAttribute('data-comment-answer-'+an+'-user', theUser.id);
        comment.setAttribute('data-comment-answer-'+an+'-user-name', theUser.name);
        comment.setAttribute('data-comment-answer-'+an+'-user-avatar', theUser.avatar);
        comment.setAttribute('data-comment-answer-'+an+'-date', new Date().getTime());
        commentHelpers.deactivateAll();
    ...
    commentHelpers.cancelSubmitComment = function () {
        ...
        if (commentTextBox) {
            ...
            if (commentHelpers.findComment(id).getAttribute('data-comment').length === 0) {
    ...
    commentHelpers.submitAnswerUpdate = function (id, answerId, commentText) {
        jQuery('#comment-'+id).attr('data-comment-answer-'+answerId+'-comment',commentText);
        commentHelpers.deactivateAll();
        editorHelpers.documentHasChanged();
        commentHelpers.layoutComments();
    };
    ...
    commentHelpers.bindEvents = function () {
        ...
        jQuery(document).on('click', '.submit-comment-answer-edit', function () {
            ...
            commentHelpers.submitAnswerUpdate(commentId,answerId,theValue);    
    ...
    commentHelpers.deleteCommentAnswer = function (id,answerId) {
        ...
        var comment = commentHelpers.findComment(id);
        while (true) {
            if (!comment.hasAttribute('data-comment-answer-'+(answerId+1)+'-comment')) {
                comment.removeAttribute('data-comment-answer-'+answerId+'-comment');
                comment.removeAttribute('data-comment-answer-'+answerId+'-user');
                comment.removeAttribute('data-comment-answer-'+answerId+'-user-name');
                comment.removeAttribute('data-comment-answer-'+answerId+'-user-avatar');
                comment.removeAttribute('data-comment-answer-'+answerId+'-date');
                break;
            } else {
                comment.setAttribute('data-comment-answer-'+answerId+'-comment', comment.getAttribute('data-comment-answer-'+(answerId+1)+'-comment'));
                comment.setAttribute('data-comment-answer-'+answerId+'-user', comment.getAttribute('data-comment-answer-'+(answerId+1)+'-user'));
                comment.setAttribute('data-comment-answer-'+answerId+'-user-name', comment.getAttribute('data-comment-answer-'+(answerId+1)+'-user-name'));
                comment.setAttribute('data-comment-answer-'+answerId+'-user-avatar', comment.getAttribute('data-comment-answer-'+(answerId+1)+'-user-avatar'));
                comment.setAttribute('data-comment-answer-'+answerId+'-date', comment.getAttribute('data-comment-answer-'+(answerId+1)+'-date'));
                answerId++;
            }
    ...
    commentHelpers.layoutComments = function () {
        ...
        var theComments = jQuery('.comment'), activeCommentWrapper;
