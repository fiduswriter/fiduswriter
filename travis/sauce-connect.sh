...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=17ba85270ce74bc868e9fed442332e7aad23083b;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=5ed57093d975306d889ae83dc8f8c54db3dffc49;;
esac
SC_DISTRIBUTION=sc-4.3.15-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}
