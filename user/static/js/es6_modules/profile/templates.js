...
export let confirmDeleteAvatarTemplate = '<div id="confirmdeletion" title="'
    + gettext('Confirm deletion') + '"><p>'
    + gettext('Delete the avatar') + '?</p></div>'
/** A template to change the user avatar. */
export let changeAvatarDialogTemplate = '<div id="change-avatar-dialog" title="' + gettext('Upload your profile picture') + '">\
...
export let deleteUserDialogTemplate = '<div id="confirmaccountdeletion" title="'
    + gettext('Confirm deletion') + '"><p>'
...
export let changeEmailDialogTemplate = '<div id="fw-add-email-dialog" title="' + gettext('Add Email') + '">\
...
export let deleteEmailDialogTemplate = _.template('<div id="fw-confirm-email-dialog" title="<%= title %>">\
        <p><%- text %></p>\
    </div>');
/** A template for the change password dialog of the user account. */
export let changePwdDialogTemplate = '<div id="fw-change-pwd-dialog" title="' + gettext('Change Password') + '">\
        <table class="ui-dialog-content-table"><tbody>\
