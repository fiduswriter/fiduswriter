...
let confirmAccountFormTemplate = ({userName, email}, confirmQuestionsTemplates) =>
    `<p>${
        interpolate(
            gettext(
                'Please confirm that you own the email <a href="mailto:%(email)s">%(email)s</a>, that you apply for the username %(userName)s, and that you have read and agree to the <a href="/pages/terms/" target="_blank">Terms and Conditions</a> and acknowledge our <a href="/pages/privacy/" target="_blank">Privacy Policy</a>.'
            ),
            {email, userName},
            true
        )
