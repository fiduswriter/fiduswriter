    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(max_length=500, null=True, upload_to=b'image_thumbnails', blank=True)),
                ...
                ('uploader', models.ForeignKey(related_name=b'uploader', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
