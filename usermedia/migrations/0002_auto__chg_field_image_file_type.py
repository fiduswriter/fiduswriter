...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.file_type'
        db.alter_column(u'usermedia_image', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Image.file_type'
        db.alter_column(u'usermedia_image', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
