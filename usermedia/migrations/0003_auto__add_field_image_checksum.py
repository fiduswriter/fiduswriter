...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.checksum'
        db.add_column(u'usermedia_image', 'checksum',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.checksum'
        db.delete_column(u'usermedia_image', 'checksum')
