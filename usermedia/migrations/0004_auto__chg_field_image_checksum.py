...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.checksum'
        db.alter_column(u'usermedia_image', 'checksum', self.gf('django.db.models.fields.BigIntegerField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Image.checksum'
        db.alter_column(u'usermedia_image', 'checksum', self.gf('django.db.models.fields.IntegerField')(max_length=50))
